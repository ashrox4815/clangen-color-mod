...
for x in [
    ...
    'fadestarclan', 'fadedarkforest', 'unnatural_colors_mod/singlecolours', 'unnatural_colors_mod/speckledcolours',
	'unnatural_colors_mod/tabbycolours', 'unnatural_colors_mod/bengalcolours', 'unnatural_colors_mod/marbledcolours',
	'unnatural_colors_mod/rosettecolours', 'unnatural_colors_mod/smokecolours', 'unnatural_colors_mod/tickedcolours',
	'unnatural_colors_mod/mackerelcolours', 'unnatural_colors_mod/classiccolours', 'unnatural_colors_mod/agouticolours',
	'unnatural_colors_mod/singlestripecolours', 'unnatural_colors_mod/sokokecolours'

]:
    if 'lineart' in x and game.config['fun']['april_fools']:
        sprites.spritesheet(f"sprites/aprilfools{x}.png", x)
    elif 'unnatural_colors_mod' in x:
    	sprites.spritesheet(f"sprites/{x}.png", x[21:] + "UN")
    else:
...
for a, i in enumerate(['EXTRA', 'ONEEAR', 'BROKEN', 'LIGHTTUXEDO', 'BUZZARDFANG', 'RAGDOLL', 
    'LIGHTSONG', 'VITILIGO', 'BLACKSTAR', 'PIEBALD', 'CURVED', 'PETAL', 'SHIBAINU', 'DAPPLEPAW']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('singlecoloursUN', (a, 0), f'single{i}')
# tabby
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('tabbycoloursUN', (a, 0), f'tabby{i}')
# marbled
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('marbledcoloursUN', (a, 0), f'marbled{i}')
# rosette
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('rosettecoloursUN', (a, 0), f'rosette{i}')
# smoke
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('smokecoloursUN', (a, 0), f'smoke{i}')
# ticked
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('tickedcoloursUN', (a, 0), f'ticked{i}')
# speckled
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('speckledcoloursUN', (a, 0), f'speckled{i}')
# bengal
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('bengalcoloursUN', (a, 0), f'bengal{i}')
# mackerel
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('mackerelcoloursUN', (a, 0), f'mackerel{i}')
# classic
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('classiccoloursUN', (a, 0), f'classic{i}')
# sokoke
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('sokokecoloursUN', (a, 0), f'sokoke{i}')
# agouti
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('agouticoloursUN', (a, 0), f'agouti{i}')
# singlestripe
for a, i in enumerate(['WHITE', 'PALEGREY', 'SILVER', 'GREY', 'DARKGREY', 'GHOST', 'BLACK']):
...
for a, i in enumerate(['PINK', 'RED', 'LIME', 'DARKGREEN', 'CYAN', 'DARKBLUE', 'PURPLE']):
	sprites.make_group('singlestripecoloursUN', (a, 0), f'singlestripe{i}')
